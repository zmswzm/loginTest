...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/syedu/system/school/css/index.css">
</head>
...
<div class="row">
    <div class="panel-body">
            ...
            <div class="panel-body">
                <form id="formSearch" class="form-horizontal">
                    <div class="form-group" style="margin-top: 5px">
                        <label class="control-label col-sm-1" for="cSchoolName">学校名称</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" id="cSchoolName" name = "cSchoolName">
                        </div>

                        <div class="col-sm-3" style="text-align: left;">
                            <button type="button" style="margin-left: 10px" id="btn-query" class="btn btn-primary" onclick = "cfind()">查询</button>
                            <button type="button" style="margin-left: 10px" id="btn-add" class="btn btn-primary" onclick = "add()">新增学校</button>
                        </div>
                    </div>
                </form>
            </div>
       ...
       <table class="table table-hover" id = "mySchoolTab">
           <thead>
           <tr>
               <th data-field="id">学校编码</th>
               <th data-field="schoolName">学校名称</th>
               <th data-field="schoolNo">当前批次</th>
   ...
   <script type="text/javascript" src="/syedu/system/school/js/index.js"></script>
</body>
</html>