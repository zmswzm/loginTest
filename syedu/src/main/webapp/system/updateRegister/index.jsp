...
<body>
    ...
    <form role="form" id="form">
        <h2 class="form-signin-heading text-center" id="formTitle">报名填单</h2>
        ...
        <div class="form-group">
            ...
            <select name="school" class="form-control" id="school"  onchange = "schoolChange(this.options[this.options.selectedIndex].value)">
            </select>
        </div>
        <div class="form-group">
            <label for="yearNo">&nbsp&nbsp批次号</label>
            <input type="text" class="form-control" name="yearNo" id="yearNo" required disabled>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type = "button" id="submit" class="btn btn-primary btn-lg btn-block" value = "提&nbsp&nbsp交" onclick="regsub()">
        </div>
    </form>
    <script src="https://cdn.bootcss.com/jquery/2.1.1/jquery.min.js"></script>
    <script src="https://cdn.bootcss.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/syedu/system/updateRegister/js/index.js"></script>
</body>
</html>